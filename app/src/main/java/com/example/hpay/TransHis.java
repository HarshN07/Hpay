...
public class TransHis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                redirectActivity(TransHis.this,HomePage.class);
            }
        });
        transHis.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(TransHis.this,TransHis.class);
            }
        });
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(TransHis.this,"Logged out successfully",Toast.LENGTH_SHORT);
                redirectActivity(TransHis.this,MainActivity.class);
            }
        });
